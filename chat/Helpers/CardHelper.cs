...
namespace GreatWall.Helpers
{
    public static class CardHelper
    {
        ...
        public static Attachment GetVideoCard(string strTitle, string strSubTitle, string strImage,
                                             string strButtonText, string strButtonValue)
        {
            //Create image object
            List<CardImage> images = new List<CardImage>();
        ...
        public static Attachment GetHero2Card(string strTitle, string strImage,
                                             string strButtonText, string strButtonValue)
        {
            //Create image object
            List<CardImage> images = new List<CardImage>();
